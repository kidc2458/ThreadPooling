// ThreadPooling.cpp : 콘솔 응용 프로그램에 대한 진입점을 정의합니다.
//
/*
...
DWORD AddWorkToPool(WORK work)
{
	...
	//Work 등록 후, 대기중인 쓰레드를 모두 깨워 일을 시작하도록 함
...
//*********************************************************//
// Thread Pool에 Work을 가져올 때 호출되는 함수
// gThreadPool에 대한 접근을 보호하기 위해 정의
//*********************************************************//
...
int _tmain(int argc, TCHAR* argv[])
{
	...
	Sleep(50000);	//메인 쓰레드가 엄저 소멸되는 현상 방지
    return 0;
}
